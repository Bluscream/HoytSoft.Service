...
namespace HoytSoft.ServiceBase.Base.Notifications
{
    ...
    public static class SystemMetrics
    {
        public enum MetricsType : int
        {
            ...
            SM_NETWORK = 63,
            /// <summary>
            /// he value that specifies how the system is started:
            ...
            /// <para>SM_IMMENABLED indicates whether the system is ready to use a Unicode-based IME on a Unicode application. To ensure that a language-dependent IME works, check SM_DBCSENABLED and the system ANSI code page. Otherwise the ANSI-to-Unicode conversion may not be performed correctly, or some components like fonts or registry settings may not be present.</para>
            /// </summary>
            SM_IMMENABLED = 82,
            /// <summary>
            ...
            /// <para>You can use terminal services management tools such as Terminal Services Manager (tsadmin.msc) and shadow.exe to control a remote session. When a session is being remotely controlled, another user can view the contents of that session and potentially interact with it.</para>
            /// </summary>
            SM_REMOTECONTROL = 0x2001,
            SM_CARETBLINKINGENABLED = 0x2002,
            /// <summary>
            /// Reflects the state of the laptop or slate mode, 
            /// 0 for Slate Mode and non-zero otherwise. When this system metric changes, the system sends a broadcast message via WM_SETTINGCHANGE with "ConvertibleSlateMode" in the LPARAM.
            /// </summary>
        ...
        /// </summary>
        [Flags]
        public enum SM_ARRANGE
        {
            /// <summary>
            /// Start at the lower-left corner of the screen. The default position.
            /// </summary>
            ...
            /// <summary>
            /// Start at the upper-left corner of the screen. Equivalent to ARW_STARTTOP.
            /// </summary>
            ARW_TOPLEFT             =    0x0002,
            /// <summary>
